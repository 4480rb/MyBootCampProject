...
const getMovieBy=async(type,x)=>{
    
    try {
        let movie = await movieModel.findOne({[type]:x})
        return movie;
...
module.exports = { getAllMoviesFromJson, getAllMovies, getMovieBy, addMovie, addMovies, updateMovie, deleteMovieById }